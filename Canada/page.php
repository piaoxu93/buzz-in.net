...
$Page_size=10; 
$comments = array();
$result2 = mysql_query("SELECT * FROM comment_canada where ID=$ID ORDER BY pid desc");
...
$offset=$Page_size*($page-1); 
$comments = array();
$sql="select * from comment_canada where ID=$ID order by pid desc limit $offset,$Page_size"; 
$result=mysql_query($sql,$link); 
