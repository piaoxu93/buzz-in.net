...
echo "<div id='most_voted' style='background-image:url(image/most_voted.png);'>
    <p><strong>&nbspPiù votati <span style='color:#DC143C; font-size:16px;'>»</span>&nbsp&nbsp&nbsp </strong><a onclick=\"showMostVoted('lastmonth')\">Questo mese</a><span>&nbsp&nbsp&nbsp </span><a style='color:#b00;' onclick=\"showMostVoted('alltime')\">Totale</a></p>
	  </div>
...
echo "<div id='most_voted' style='background-image:url(image/most_voted.png);'>
    <p><strong>&nbspPiù votati <span style='color:#DC143C; font-size:16px;'>»</span>&nbsp&nbsp&nbsp </strong><a style='color:#b00;' onclick=\"showMostVoted('lastmonth')\">Questo mese</a><span>&nbsp&nbsp&nbsp </span><a onclick=\"showMostVoted('alltime')\">Totale</a></p>
	  </div>
	  <ul id='most_voted_list'>";
}
