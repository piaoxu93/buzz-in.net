...
<html>
<head>
      <title>Buzz-in.net-Italia</title>
...
<body>
	  ...
	  <a name="top"></a>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
		    <div id="button" style="width:70px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="index.php" style="color:#15c;padding:8px 0 0 16px;">Home</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			 ...
			 <div id="editors">
			  ...
			  <div id="title">
			    <a href="newest.php">Recenti &nbsp&nbsp<span>»</span></a>
			  </div>
	...
	<!--		<div style="float:left;width:300px; height:18px; margin:0 0 0 10px;">
			...
			<div class="container_4" id="most">
			  <div id="most_voted" style="background-image:url(image/most_voted.png);">
			   <p><strong>&nbspPiù votati <span style="color:#DC143C; font-size:16px;">»</span>&nbsp&nbsp&nbsp </strong><a onclick="showMostVoted('lastmonth')">Questo mese</a><span>&nbsp&nbsp&nbsp </span><a onclick="showMostVoted('alltime')" >Totale</a></p>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="people.php">Persone &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="life.php">Vita &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="politics.php">Politica &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="events.php">Eventi &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="entertainment.php">Spettacoli &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="culture.php">Cultura &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="science_tech.php">Scienza e tecnologia &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="sports.php">Sport &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left" style="margin-bottom:10px;">
			  <div id="title_left">
			    <a href="fun.php">Divertimento &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right" style="margin-bottom:10px;">
			  <div id="title_right">
			    <a href="articles.php">Articoli &nbsp&nbsp<span>»</span></a>
			  </div>
