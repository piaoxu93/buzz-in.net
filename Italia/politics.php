	  ...
	  <a name="top"></a>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
			...
			<div id="button" style="width:79px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="politics.php" style="color:#15c;padding:8px 0 0 16px;">Politica</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			  <div id="title">
			    <a href="newest.php">Politica &nbsp&nbsp<span>»</span></a>
			  </div>
