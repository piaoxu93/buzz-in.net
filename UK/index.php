...
<body>
	  ...
	  <a name="top"></a>
          ...
          <div id="topBar">
            ...
            <div id="leftBar">           
			  <div id="icon_facebook">
			    <a href="http://www.facebook.com/BuzzInnetuk" target="_blank">
		      ...
		      <form method="get" action="http://www.google.com.hk/search">
			    <div id="search">
				  <p style="margin:0;">
				  <input type="hidden" name="sitesearch" value="buzz-in.net/UK">
				  </p>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
		    <div id="button" style="width:77px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="index.php" style="color:#15c;padding:8px 0 0 19px;">Home</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			 ...
			 <div id="editors">
			  ...
			  <div id="title">
			    <a href="newest.php">Newest &nbsp&nbsp<span>»</span></a>
			  </div>
	...
	<!--		<div style="float:left;width:300px; height:18px; margin:0 0 0 10px;">
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="people.php">People &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="life.php">Life &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="politics.php">Politics &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="events.php">Events &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="entertainment.php">Entertainment &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="culture.php">Culture &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="science_tech.php">Science & Tech &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="sports.php">Sports &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left" style="margin-bottom:10px;">
			  <div id="title_left">
			    <a href="fun.php">Fun &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right" style="margin-bottom:10px;">
			  <div id="title_right">
			    <a href="articles.php">Articles &nbsp&nbsp<span>»</span></a>
			  </div>
          ...
          <div id="topBar">
            ...
            <div id="leftBar">           
			  ...
			  <div id="icon_America">
			    <a href="http://www.facebook.com/" class="icon_America" target="_blank">
				<img src="image/America.jpg"></a>
			  </div>
			  <div id="icon_English">
			    <a href="http://www.facebook.com/" class="icon_English" target="_blank">
				<img src="image/English.jpg"></a>
			  </div>
			  <div id="icon_Canada">
			    <a href="http://www.facebook.com/" class="icon_Canada" target="_blank">
				<img src="image/Canada.jpg"></a>
			  </div>
			  <div id="icon_Australia">
			    <a href="http://www.facebook.com/" class="icon_Australia" target="_blank">
				<img src="image/Australia.jpg"></a>
			  </div>
			  <div id="icon_India">
			    <a href="http://www.facebook.com/" class="icon_India" target="_blank">
				<img src="image/India.jpg"></a>
			  </div>
			  <div id="icon_Italian">
			    <a href="http://www.facebook.com/" class="icon_Italian" target="_blank">
				<img src="image/Italian.jpg"></a>
			  </div>
			  <div id="icon_China">
			    <a href="http://www.facebook.com/" class="icon_China" target="_blank">
				<img src="image/China.jpg"></a>
			  </div>
			  <div id="icon_Macedonia">
			    <a href="http://www.facebook.com/" class="icon_Macedonia" target="_blank">
				<img src="image/Macedonia.jpg"></a>
			  </div>
			  <div id="marketing">
			  <a href="/">Marketing</a>
