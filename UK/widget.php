...
#generator_footer{ margin-left:-113px; }</style>
      ...
      box.innerHTML = '<textarea readonly><iframe frameborder="0" seamless src="http://buzz-in.net/UK/widget/'+numn.value+' "height="'+h+'px" width="'+w+'px"></iframe></textarea>';
  
      prev.innerHTML = '<iframe class="preview-iframe" frameborder="0" seamless src="http://buzz-in.net/UK/widget/'+numn.value+' "height="'+h+'px" width="'+w+'px"></iframe>'
      }
    ...
    <div class="drop">
        ...
        </select></div></div><div id="code"><textarea readonly><iframe frameborder="0" seamless src="http://buzz-in.net/UK/widget/widget_4.php" height="428px" width="347px"></iframe>
    </textarea></div>
    
  </DIV></DIV></TD><TD class="headlines-gadget-col"><DIV class="column2"><DIV id="headline-gadgets" class="wrapper"></DIV></DIV></TD></TR></TBODY></TABLE></DIV></DIV></DIV></TD></TR></TBODY></TABLE><div id="preview" ><iframe class="preview-iframe" frameborder="0" seamless src="http://buzz-in.net/UK/widget/widget_4.php" height="428px" width="347px"></iframe></div></DIV></DIV></DIV><DIV class="clearfooter"></DIV></DIV>
