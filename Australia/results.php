		    ...
		    <div class="container_1_left">
			 ...
			 <div id="results_page_option">
			  <?php
				...
				if($ifsuccess == 2)
				{echo "<p style='margin:0px;'><span style='color:red;'>You have already voted!&nbsp</span>See the results:</p>";}
				else if($ifsuccess == 1)
				{echo "<p style='margin:0px;'><span style='color:blue;'>Your vote has been accepted!&nbsp</span>See the results:</p>";}
				else {;}
				}
			    $n=1;
				$i=1;
				...
				echo "<span style='clear:both;margin-top:13px;font-size:12px;'>Number of votes :&nbsp $sum</span>";
				?>
			 ...
			 <div id="comment" style="clear:both;float:left;margin:0px auto 0 65px;"> 
              ...
              ?>
			  <div style="font-size:17px;font-weight:bold;margin:50px 0 5px -70px;">Leave a comment</div>
              ...
              <label for="body" style="font-size:12px;">Comment</label>
			  ...
			  <div id="see_comments" style="font-size:17px;font-weight:bold;margin:20px 0 5px -70px;">See the comments</div>
