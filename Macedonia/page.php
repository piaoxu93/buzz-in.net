...
$key="<div class=\"pages\">"; 
if($page!=1){ 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?page=1\"><span>«</span>Прва</a> "; //第一页 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?page=".($page-1)."\"> Прет</a>"; //上一页 
}else { 
$key.="<a class=\"page\"><span>«</span>Прва</a> ";//第一页 
$key.="<a class=\"page\"> Прет</a>"; //上一页 
} 
if($pages>$page_len){ 
//如果当前页小于等于左偏移 
if($page<=$pageoffset){ 
...
if($page!=$pages){ 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?page=".($page+1)."\"> След</a> ";//下一页 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?page={$pages}\"> Посл<span>»</span></a>"; //最后一页 
}else { 
$key.="<a class=\"page\"> След</a> ";//下一页 
$key.="<a class=\"page\"> Посл<span>»</span></a>"; //最后一页 
}
$key.='</div>'; 
...
$Page_size=10; 
$comments = array();
$result2 = mysql_query("SELECT * FROM comment_macedonia where ID=$ID ORDER BY pid desc");
...
$offset=$Page_size*($page-1); 
$comments = array();
$sql="select * from comment_macedonia where ID=$ID order by pid desc limit $offset,$Page_size"; 
$result=mysql_query($sql,$link); 
...
$key="<div class=\"pages\">"; 
if($page!=1){ 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?ID=$ID&page=1\"><span>«</span>Прва</a> "; //第一页 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?ID=$ID&page=".($page-1)."\"> Прет</a>"; //上一页 
}else { 
$key.="<a class=\"page\"><span>«</span>Прва</a> ";//第一页 
$key.="<a class=\"page\"> Прет</a>"; //上一页 
} 
...
if($page!=$pages){ 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?ID=$ID&page=".($page+1)."\"> След</a> ";//下一页 
$key.="<a class=\"page\" href=\"".$_SERVER['PHP_SELF']."?ID=$ID&page={$pages}\"> Посл<span>»</span></a>"; //最后一页 
}else { 
$key.="<a class=\"page\"> След</a> ";//下一页 
$key.="<a class=\"page\"> Посл<span>»</span></a>"; //最后一页 
}
