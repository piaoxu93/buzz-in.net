		    ...
		    <div class="container_1_left">
			 ...
			 <div id="results_page_option">
			  <?php
				...
				if($ifsuccess == 2)
				{echo "<p style='margin:0px;'><span style='color:red;'>Веќе гласавте на ова прашање!&nbsp</span>Погледнете ги резултатите:</p>";}
				else if($ifsuccess == 1)
				{echo "<p style='margin:0px;'><span style='color:blue;'>Вашиот глас е прифатен!&nbsp</span>Погледнете ги резултатите:</p>";}
				else {;}
				}
			    $n=1;
				$i=1;
				...
				echo "<span style='clear:both;margin-top:13px;font-size:12px;'>Број на гласови :&nbsp $sum</span>";
				?>
			 ...
			 <div id="comment" style="clear:both;float:left;margin:0px auto 0 65px;"> 
              ...
              ?>
			  <div style="font-size:17px;font-weight:bold;margin:50px 0 5px -70px;">Оставете коментар</div>
			
			  <div id="addCommentContainer" style="margin-left:-70px;">
	          <form id="addCommentForm" method="post" action="">
    	      <div>
        	  <label for="name" style="font-size:12px;">Име</label>
        	  <input type="text" name="name" id="name" />
            
              <label for="email" style="font-size:12px;">Email</label>
              <input type="text" name="email" id="email" />
            
              <label for="body" style="font-size:12px;">Коментар</label>
			  ...
			  <div id="see_comments" style="font-size:17px;font-weight:bold;margin:20px 0 5px -70px;">Погледнете ги коментарите</div>
