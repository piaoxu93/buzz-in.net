	  ...
	  <a name="top"></a>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
			...
			<div id="button" style="width:76px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="fun.php" style="color:#15c;padding:8px 0 0 13px;">Забава</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			  <div id="title">
			    <a href="newest.php">Забава &nbsp&nbsp<span>»</span></a>
			  </div>
