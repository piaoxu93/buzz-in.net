	  ...
	  <a name="top"></a>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
			...
			<div id="button" style="width:94px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="politics.php" style="color:#15c;padding:8px 0 0 14px;">Политика</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			  <div id="title">
			    <a href="newest.php">Политика &nbsp&nbsp<span>»</span></a>
			  </div>
