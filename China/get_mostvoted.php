...
echo "<div id='most_voted' style='background-image:url(image/most_voted.png);'>
    <p><strong>&nbsp最多投票 <span style='color:#DC143C; font-size:16px;'>»</span>&nbsp&nbsp&nbsp </strong><a onclick=\"showMostVoted('lastmonth')\">最近一个月</a><span>&nbsp&nbsp&nbsp </span><a style='color:#b00;' onclick=\"showMostVoted('alltime')\">所有时间</a></p>
	  </div>
...
echo "<div id='most_voted' style='background-image:url(image/most_voted.png);'>
    <p><strong>&nbsp最多投票 <span style='color:#DC143C; font-size:16px;'>»</span>&nbsp&nbsp&nbsp </strong><a style='color:#b00;' onclick=\"showMostVoted('lastmonth')\">最近一个月</a><span>&nbsp&nbsp&nbsp </span><a onclick=\"showMostVoted('alltime')\">所有时间</a></p>
	  </div>
	  <ul id='most_voted_list'>";
}
