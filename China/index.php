...
<body>
	  ...
	  <a name="top"></a>
		...
		<div id="menu" style="background-image:url('image/menu.png')">
		  <div id="menu_button">
		    <div id="button" style="width:84px; height:33px; background-image:url('image/homebutton.png'); margin-top:-3px;"><a href="index.php" style="color:#15c;padding:8px 0 0 25px;">主页</a></div>
		  ...
		  <div class="content">
		    <div class="container_1_left">
			 ...
			 <div id="editors">
			  ...
			  <div id="title">
			    <a href="newest.php">最新的 &nbsp&nbsp<span>»</span></a>
			  </div>
	...
	<!--		<div style="float:left;width:300px; height:18px; margin:0 0 0 10px;">
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="people.php">人们 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="life.php">生活 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="politics.php">政治 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="events.php">事件 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="entertainment.php">娱乐 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="culture.php">文化 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left">
			  <div id="title_left">
			    <a href="science_tech.php">科学与技术 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right">
			  <div id="title_right">
			    <a href="sports.php">运动 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_left" style="margin-bottom:10px;">
			  <div id="title_left">
			    <a href="fun.php">趣事 &nbsp&nbsp<span>»</span></a>
			  </div>
			...
			<div class="container_right" style="margin-bottom:10px;">
			  <div id="title_right">
			    <a href="articles.php">文章 &nbsp&nbsp<span>»</span></a>
			  </div>
